...
function Video(options = defaultOptions) {
  ...
  if (
    !wrapper &&
    (!wrapper instanceof Element || !wrapper instanceof HTMLDocument)
  )
...
Video.prototype.init = function () {
  ...
  this.icons = {
    ...
    pause:
      '<svg><rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect></svg>',
    muted:
      '<svg><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><line x1="23" y1="9" x2="17" y2="15"></line><line x1="17" y1="9" x2="23" y2="15"></line></svg>',
    volume_0:
      '<svg><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon></svg>',
    volume_1:
      '<svg><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>',
    volume_2:
      '<svg><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>',
    fullscreen:
      '<svg><polyline points="15 3 21 3 21 9"></polyline><polyline points="9 21 3 21 3 15"></polyline><line x1="21" y1="3" x2="14" y2="10"></line><line x1="3" y1="21" x2="10" y2="14"></line></svg>',
    exitFullscreen:
      '<svg><polyline points="4 14 10 14 10 20"></polyline><polyline points="20 10 14 10 14 4"></polyline><line x1="14" y1="10" x2="21" y2="3"></line><line x1="3" y1="21" x2="10" y2="14"></line></svg>',
  };
  ...
  if (!this.video) {
    if (!this.options.videoSrc)
      throw new Error(
        "Can not find video tag in the wrapper or videoSrc in options"
      );
...
Video.prototype.generateControls = function () {
  ...
  this.elapsedTimeSpan = this.controls.querySelector(
    ".v-controls__timing .elapsed-time"
  );
  this.remainingTimeSpan = this.controls.querySelector(
    ".v-controls__timing .remaining-time"
  );
  ...
  this.videoPlayBtn = this.wrapper.querySelector(
    ".v-controls__btns #video-play"
  );
  this.videoStopBtn = this.wrapper.querySelector(
    ".v-controls__btns #video-stop"
  );
  this.soundToggleBtn = this.wrapper.querySelector(
    ".v-controls__btns #sound-toggle"
  );
  this.videoFullscreenBtn = this.wrapper.querySelector(
    ".v-controls__btns #video-fs"
  );
  this.videoProgress = this.wrapper.querySelector(
    ".v-controls__timing input[type=range]"
  );
  this.soundRange = this.wrapper.querySelector(
    ".v-controls__btns__sound input[type=range]"
  );
};
...
Video.prototype.initListeners = function () {
  ...
  this.videoFullscreenBtn.addEventListener(
    "click",
  ...
  const animateVolumeRange = () => {
    if (this.video.muted) {
      if (+this.soundRange.value > 0) {
        this.soundRange.value = +this.soundRange.value - 0.1;
...
Video.prototype.calcProgress = function () {
  ...
  this.remainingTimeSpan.innerHTML = secToTimeStr(
